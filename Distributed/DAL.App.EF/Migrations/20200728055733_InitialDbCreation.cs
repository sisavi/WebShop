        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedBy = table.Column<string>(maxLength: 256, nullable: true),
                    ChangedAt = table.Column<DateTime>(nullable: true),
                    CommentText = table.Column<string>(maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInBaskets_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedAt = table.Column<DateTime>(nullable: true),
                    AppUserId = table.Column<Guid>(nullable: false),
                    ProductInBasketId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_ProductInBaskets_ProductInBasketId",
                        column: x => x.ProductInBasketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ProductInBasketId",
                table: "Orders",
                column: "ProductInBasketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInBaskets_AppUserId",
