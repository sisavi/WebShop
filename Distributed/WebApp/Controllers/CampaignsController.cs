...
namespace WebApp.Controllers
{
    public class CampaignsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CampaignId,Discount,StartTime,EndTime")] Campaign campaign)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CampaignId,Discount,StartTime,EndTime")] Campaign campaign)
        {
