...
namespace WebApp.ApiControllers._1._0
{
    ...
    public class ProductInBasketsController : ControllerBase
    {
        ...
        {
            return Ok((await _bll.ProductsInBaskets.GetAllAsync()).Select(e => _mapper.Map(e)));
        }
        ...
        {
            var productInBasket = await _bll.ProductsInBaskets.FirstOrDefaultAsync(id);
        ...
        public async Task<IActionResult> PutProductInBasket(Guid id, V2DTO.ProductInBasket productInBasket)
        {
            ...
            await _bll.ProductsInBaskets.UpdateAsync(_mapper.Map(productInBasket));
        ...
        public async Task<ActionResult<V2DTO.ProductInBasket>> DeleteProductInBasket(Guid id)
        {
            ...
            await _bll.ProductsInBaskets.RemoveAsync(productInBasket);
            await _bll.SaveChangesAsync();
